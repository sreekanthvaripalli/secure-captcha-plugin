...
describe('Docker Containerization', () => {
  ...
  describe('Docker Compose', () => {
    ...
    test('should have proper environment variables', () => {
      ...
      expect(content).toContain('DATABASE_URL=postgresql://postgres:postgres@postgres:5432/secure_captcha');
  ...
  describe('Security Validation', () => {
    ...
    test('should use environment variables for sensitive data', () => {
      ...
      expect(composeContent).toContain('DATABASE_URL=postgresql://postgres:postgres@postgres:5432/secure_captcha');
    });
