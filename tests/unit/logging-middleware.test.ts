...
describe('Logging Middleware', () => {
  ...
  beforeEach(() => {
    ...
    jest.spyOn(require('../../src/services/elk-logger'), 'getELKLogger').mockReturnValue(mockLogger);
  });
  ...
  describe('errorLoggingMiddleware', () => {
    ...
    test('should log security event for security-related errors', () => {
      ...
      errorLoggingMiddleware(securityError, mockRequest as Request, mockResponse as Response, nextFunction);
    ...
    test('should not log security event for non-security errors', () => {
      ...
      errorLoggingMiddleware(regularError, mockRequest as Request, mockResponse as Response, nextFunction);
    ...
    test('should detect forbidden errors', () => {
      ...
      errorLoggingMiddleware(forbiddenError, mockRequest as Request, mockResponse as Response, nextFunction);
    ...
    test('should detect authentication errors', () => {
      ...
      errorLoggingMiddleware(authError, mockRequest as Request, mockResponse as Response, nextFunction);
    ...
    test('should detect rate limit errors', () => {
      ...
      errorLoggingMiddleware(rateLimitError, mockRequest as Request, mockResponse as Response, nextFunction);
